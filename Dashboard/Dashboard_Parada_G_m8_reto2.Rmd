...
# Se agrega un poco más de espacio en el eje x para que las etiquetas se vean
  ...
  # Gráfica de ranking de Esperanza de Vida
  plot_ly(
    df_filtrado,
    x = ~life_expectancy,
    y = ~country,
...
### **Tabla Esperanza de Vida vs GDP per cápita PPP Suramérica: **

```{r}

# Se le cambian los nombres a la tabla para que queden en español
...
datatable(df_tabla,
    caption = "Esperanza de Vida Media vs GDP per cápita PPP Suramérica",
    rownames = T,
    filter = "top",
...
### Correlación entre GDP per cápita PPP y Esperanza de Vida
...
- El coeficiente de correlación de Pearson de ambas variables para Suramérica es de: 0.76.
